...
CREATE TABLE totalitems(id INTEGER PRIMARY KEY AUTOINCREMENT , name TEXT, category TEXT, brand TEXT, total INTEGER, selling INTEGER, quantity INTEGER);
...
INSERT INTO user(username, password) VALUES('q', 'q');
